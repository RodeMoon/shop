<template>
  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col flex-grow">
      <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300 bg-gray-200">
        <h1 class="text-lg font-medium">Welcome, {{AuthStore.username}}!</h1>
        <button
      ...
      <div class="flex-grow p-6 overflow-auto bg-black">
        <RouterView />
      </div>
    </div>
    <!-- Component End  -->
